...
We use \ML to denote a miller loop and \FE to denote a multiexponetiation
...
\begin{enumerate}
 ...
 \item  and $r=\mathsf{Blake(P)}$ interperted as an element of \F.

\end{enumerate}

The verifier computes $r$ from $P$ outside of the circuit,
and checks outside of the circuit that
